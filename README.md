# [SOLVED] 0xd-Error-Tracing-Data-To-From-Serial-Driver-Ft200xd-Finding
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/0xd-error-tracing-data-to-from-serial-driver-ft200xd-finding)
>
...
Use the ls -l /proc/tty/driver/ft200xd command to find the file descriptor, then use strace with the correct file descriptor.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/0xd-error-tracing-data-to-from-serial-driver-ft200xd-finding)**
